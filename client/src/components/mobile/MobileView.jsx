          ...
          <div style={{ position: 'relative', zIndex: 2, maxWidth: '640px', margin: '0 auto' }}>
            ...
            >
              {[
                {
                  label: 'LinkedIn',
                  url: 'https://www.linkedin.com/company/soultechies-corp/',
                  icon: (
                ...
                {
                  label: 'Instagram',
                  url: 'https://www.instagram.com/soultechies.corp?stkn=cnFpaWFvNW1veWRy',
                  icon: (
                ...
                {
                  label: 'Facebook',
                  url: 'https://www.facebook.com/share/1BBTk12Aw8/',
                  icon: (
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
